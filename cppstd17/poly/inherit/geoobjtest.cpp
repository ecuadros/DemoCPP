...
GOColl initColl(int num)
{
  ...
  { Line* lp = new Line{"Line" + std::to_string(i), Coord{i,i}, Coord{100*i,100*i}};
    coll.push_back(lp);
    Circle* cp = new Circle{"Circle" + std::to_string(i),  Coord{10*i,10*i}, i};
    coll.push_back(cp);
    Polygon* pp = new Polygon{"Polygon" + std::to_string(i), {Coord{i,i}, Coord{i, -i}, Coord{-i, -i}, Coord{-i, i}}};
    coll.push_back(pp);
  }
  return coll;
}
