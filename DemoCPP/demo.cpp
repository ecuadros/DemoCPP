...
/*template <typename Container, typename... Idx>
void printIdx3(const Container& coll, const Idx ... idx)
{
     printIdx<idx...>(coll);
}*/
...
void TestingArray(int a1[7], int a2[],    // pointers by language rules
...
void DemoTestArray()
{
  ...
  TestingArray(a, a, a, ExtArray, ExtArray, ExtArray, ExtArray);
